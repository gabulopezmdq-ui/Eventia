...
function ObraTipo() {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:44382/obra/getall")
  ...
  const handleNuevoTipo = () => {
    navigate("/dashboards/ObraTipo/Nuevo");
  };
  ...
  const handleVer = (rowData) => {
    ...
    if (rowData && rowData.idObra) {
      ...
      const url = `/dashboards/ObraTipo/${productId}`;
