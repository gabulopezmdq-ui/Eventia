...
function TipoObra() {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:44382/tipoObra/getall")
  ...
  const handleNuevoTipo = () => {
    navigate("/dashboards/TipoObra/Nuevo");
  };
  ...
  const handleEdicion = (rowData) => {
    if (rowData && rowData.idTipoObra) {
      ...
      const url = `/dashboards/TipoObra/Edit/${productId}`;
              ...
              table={{
                columns: [
                  ...
                  },
                  {
                    ...
                    accessor: "edit",
                    Cell: ({ row }) => (
                      <Link to={`/dashboards/TipoObra/Edit/${row.original.idTipoObra}`}>
                        <MDButton
                          variant="gradient"
                          color="info"
