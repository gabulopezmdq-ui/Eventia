...
function Conservadora() {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:44382/conservadora/getall")
  ...
  const handleNuevoTipo = () => {
    navigate("/dashboards/Conservadora/Nuevo");
  };
  const handleVer = (rowData) => {
    ...
    if (rowData && rowData.idConservadora) {
      ...
      const url = `/dashboards/Conservadora/${productId}`;
            ...
            <DataTable
              table={{
                columns: [
                  ...
                  { Header: "Cant. Operarios", accessor: "cantOpe" },
                  {
                    Header: "Actualizado",
                    accessor: "fechaAct",
