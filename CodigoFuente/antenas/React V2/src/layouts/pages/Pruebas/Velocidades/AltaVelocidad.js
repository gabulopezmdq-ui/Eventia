...
function AltaVelocidad() {
  const { id } = useParams();
  let labelTitulo = "Alta Velocidad";
  if (id) {
    labelTitulo = "Editar Velocidad";
  }
  const steps = [
    {
      label: labelTitulo,
  ...
  const apiUrl = `https://localhost:44382/velocidad`;
  return (
    <DashboardLayout>
      <DashboardNavbar />
