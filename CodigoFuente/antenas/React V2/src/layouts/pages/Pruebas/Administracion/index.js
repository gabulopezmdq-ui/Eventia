...
function Administracion() {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:44382/administracion/getall")
  ...
  const handleNuevoTipo = () => {
    navigate("/dashboards/Administracion/Nuevo");
  };

  const handleVer = (rowData) => {
    console.log(rowData);
    if (rowData && rowData.idAdministracion) {
      console.log("Editar datos:", rowData);
      const productId = rowData.idAdministracion;
      console.log(productId);
      const url = `/dashboards/Administracion/${productId}`;
            ...
            <DataTable
              table={{
                columns: [
                  ...
                  { Header: "Departamento", accessor: "dto" },
