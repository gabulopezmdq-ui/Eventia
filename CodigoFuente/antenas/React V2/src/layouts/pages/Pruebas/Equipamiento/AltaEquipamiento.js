...
function AltaEquipamiento() {
  const { id } = useParams();
  let labelTitulo = "Alta Tipo Equipamiento";
  if (id) {
    labelTitulo = "Editar Tipo Equipamiento";
  }
  const steps = [
    {
      label: labelTitulo,
  ...
  const apiUrl = `https://localhost:44382/tipoequipamiento`;
  return (
    <DashboardLayout>
      <DashboardNavbar />
