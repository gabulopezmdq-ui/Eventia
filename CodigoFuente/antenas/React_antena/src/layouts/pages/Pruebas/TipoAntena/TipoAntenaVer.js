...
function TipoAntenaVer() {
  ...
  useEffect(() => {
    ...
    axios
      .get(process.env.REACT_APP_API_URL + `ANT_TipoAntenas/getbyid?id=${id}`) // Actualiza el endpoint a `ANT_Antenas`
      .then((response) => {
          ...
          <MDBox>
            <Card>
              ...
              <div className="contenidoCard">
                ...
                <MDButton onClick={() => handleEditarEstadoTramite(apoderadosData?.idTipoAntena)}>
                  Editar
                </MDButton>
              </div>
            </Card>
