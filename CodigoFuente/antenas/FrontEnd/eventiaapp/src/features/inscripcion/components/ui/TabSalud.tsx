            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                        <label className={LABEL_CLASS}>Necesidad especial</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-1.5">
                        <label className={LABEL_CLASS}>Cobertura médica</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-1.5 sm:col-span-2">
                        <label className={LABEL_CLASS}>Observaciones para el equipo</label>
                        <textarea
                ...
                <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <div>
                        <span className="text-sm font-semibold text-gray-900 dark:text-white flex items-center gap-1.5">
                            ...
                            Autorizo atención médica de emergencia *
                        </span>
