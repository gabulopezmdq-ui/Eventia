        ...
        <section className="max-w-4xl mx-auto pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-muted text-sm mt-1">Completa los detalles para tu próxima gran experiencia</p>
                </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="p-6 rounded-2xl bg-card-bg border border-card-border backdrop-blur-xl transition-all hover:border-muted/50">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-muted uppercase tracking-widest mb-2 ml-1">Anfitriones</label>
                                <input
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-bold text-muted uppercase tracking-widest mb-2 ml-1">Fecha y Hora</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full pl-11 pr-4 py-3.5 rounded-xl bg-background border border-card-border focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all text-foreground outline-none"
                                        />
                                    </div>
                                </div>
                                <div>
                                    <label className="block text-xs font-bold text-muted uppercase tracking-widest mb-2 ml-1">Tipo de Evento</label>
                                    <select
                                        name="idTipoEvento"
                                        value={form.idTipoEvento}
                                        onChange={handleChange}
                                        className="w-full p-3.5 rounded-xl bg-background border border-card-border focus:border-indigo-500/50 transition-all text-foreground outline-none appearance-none"
                                    >
                    ...
                    <div className="p-6 rounded-2xl bg-card-bg border border-card-border backdrop-blur-xl transition-all hover:border-muted/50">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-muted uppercase tracking-widest mb-2 ml-1">Lugar</label>
                                <input
                                    name="lugar"
                    ...
                    <div className="p-6 rounded-2xl bg-card-bg border border-card-border backdrop-blur-xl transition-all hover:border-muted/50">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-lg font-semibold text-foreground">Mensajes del Evento</h2>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={3}
                                    className="w-full p-4 rounded-xl bg-background border border-card-border focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 transition-all text-foreground outline-none placeholder:text-muted resize-none"
                                />
                            </div>

                            <div>
                                <label className="text-xs font-bold text-muted uppercase tracking-widest mb-2 ml-1 block">
                                    Saludo / Dedicatoria
                                </label>
                                <textarea
                                    name="saludo"
                ...
                <div className="space-y-6">
                    <div className="p-6 rounded-2xl bg-indigo-600/5 border border-indigo-500/20 backdrop-blur-xl sticky top-28">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="font-semibold italic text-foreground">Resumen y Publicación</h2>
                        </div>

                        <div className="space-y-4 mb-8">
                            <div className="flex items-center gap-3 text-sm text-muted p-2 rounded-lg bg-muted/10 border border-muted/10">
                        ...
                        <div>
                            <label className="text-xs font-bold text-muted uppercase tracking-widest mb-2 block">Notas Internas</label>
                            <textarea
                                name="notas"
                                ...
                                onChange={handleChange}
                                rows={4}
                                className="w-full p-4 rounded-xl bg-background/50 border border-card-border focus:border-indigo-500/50 transition-all text-sm text-foreground outline-none placeholder:text-muted resize-none mb-6"
                            />
                        </div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <button
                                type="button"
                                onClick={() => router.back()}
                                className="w-full py-4 rounded-xl border border-card-border text-muted hover:text-foreground hover:bg-muted/10 font-medium text-sm transition-all"
                            >
                                Cancelar
                            </button>
                        </div>
