...
![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.001.png)

Flujos de decisiones:

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.002.png)


Esto me armó el chatgpt como para tener una idea de como se organiza la info:

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.003.png) 

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.004.png) ![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.005.png)

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.006.png) ![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.007.png)

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.008.png) ![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.009.png)

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.010.png) ![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.011.png)

![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.012.png) ![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.013.png)
...
![](Aspose.Words.c6cdca47-a1aa-495d-94c4-f2a4207d8adc.014.png)
...
Definir si cada participante va a requerir retiro y en caso de que lo requiera, quién va a ser el autorizado para retirar
...
- Requiere Autorización de Retiro?
  - Combo	

**Endpoint**:

**GET /modalidades\_retiro/GetAll?idIdioma=1** (idioma del evento o programa porque sirve para ambos)
...
`        `"codigo": "SE\_RETIRA\_SOLO",

`        `"texto": "Se retira solo/a",
...
`        `"codigo": "REQUIERE\_AUTORIZADO",

`        `"texto": "Lo retira una persona autorizada",
...
\
  ...
  `  `"modalidad\_retiro": "REQUIERE\_AUTORIZADO",
  ...
  `      `"nombre\_autorizado": "Laura García",

  `      `"telefono\_autorizado": "+34600111222",
...
El back controla al guardar:

- Si modalidad\_retiro = REQUIERE\_AUTORIZADO --> debe venir al menos 1 autorizado\_retiro con nombre
- Si modalidad\_retiro = SE\_RETIRA\_SOLO --> no exige autorizados
- Si modalidad retiro = NO\_APLICA --> no exige autorizados
- Si modalidad retiro = null --> no exige autorizados

Ejemplos:

*Adulto*

"modalidad\_retiro": "SE\_RETIRA\_SOLO",
