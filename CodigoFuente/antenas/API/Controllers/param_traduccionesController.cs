...
namespace API.Controllers
{
    ...
    public class param_traduccionesController : ControllerBase
    {
            ...
            [FromQuery] bool soloActivos = true)
        {
            ...
            if (entCfg == null)
                return BadRequest("Entidad inv�lida o inactiva.");
            ...
            if (!idiomaExiste)
                return BadRequest("Idioma inv�lido o inactivo.");
...
//            foreach (var it in itemsNorm)
//            {
//                // Si el texto est� vac�o, no inserto ni actualizo. (Si prefer�s �vaciar�, avisame y lo cambiamos)
//                if (string.IsNullOrWhiteSpace(it.texto))
//                    continue;
