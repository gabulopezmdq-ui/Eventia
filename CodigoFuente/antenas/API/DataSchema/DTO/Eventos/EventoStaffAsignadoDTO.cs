...
{
    public class EventoStaffAsignadoDTO
    {
        [JsonPropertyName("id_evento_staff")]
    ...
    public class AddEventoStaffDesdeCuentaRequest
    {
        [JsonPropertyName("id_staff")]
        public long id_staff { get; set; }
    ...
    public class AddEventoStaffNuevoRequest
    {
        [JsonPropertyName("nombre")]
    ...
    public class UpdateEventoStaffAsignadoRequest
    {
        [JsonPropertyName("activo")]
        public bool activo { get; set; }
    }

    public class StaffJoinRolDTO
    {
        [JsonPropertyName("id_evento_staff")]
        public long id_evento_staff { get; set; }
