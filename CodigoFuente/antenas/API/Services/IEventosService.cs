...
namespace API.Services
{
    ...
    {
        Task<EventoResponse> CrearEventoAsync(long idUsuario, EventoCreateRequest req, bool isSuperAdmin = false);
        ...
        Task<EventoResponse> UpdateGeneralAsync(long idUsuario, long idEvento, EventoUpdateGeneralRequest req, bool isSuperAdmin = false);
        Task<List<EventoResponse>> MisEventosCuentaAsync(long idUsuario, long? idUnidad = null, long? idCliente = null, string? estado = null);
        Task<EventoResponse> UpdateConfiguracionAsync(long idUsuario, long idEvento, EventoUpdateConfiguracionRequest req, bool isSuperAdmin = false);
