...
namespace API.Services.Cuentas
{
    ...
    {
        Task<List<admin_cuenta_admin_dto>> GetAllAsync(string estado = null);
        ...
        Task<admin_reactivar_cuenta_response> ReactivarAsync(admin_reactivar_cuenta_request request, long id_usuario_admin);
    }
}