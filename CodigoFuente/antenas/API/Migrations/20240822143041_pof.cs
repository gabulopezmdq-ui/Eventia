...
{
    /// <inheritdoc />
    public partial class pof : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vigente = table.Column<string>(type: "char(1)", fixedLength: true, nullable: false),
                    EstablecimientoIdPOF = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MEC_Establecimientos", x => x.IdEstablecimiento);
                    table.ForeignKey(
                        name: "FK_MEC_Establecimientos_MEC_POF_EstablecimientoIdPOF",
                        column: x => x.EstablecimientoIdPOF,
                        principalTable: "MEC_POF",
                        principalColumn: "IdPOF");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MEC_Establecimientos_EstablecimientoIdPOF",
                table: "MEC_Establecimientos",
                column: "EstablecimientoIdPOF");
