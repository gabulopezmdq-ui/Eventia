...
{
    /// <inheritdoc />
    public partial class tiposLiquidaciones : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MEC_TMPMecanizadas",
                columns: table => new
                {
                    idTMPMecanizada = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    idCabecera = table.Column<int>(type: "integer", nullable: false),
                    FechaImportacion = table.Column<DateTime>(type: "DateTime", fixedLength: true, nullable: true),
                    MesLiquidacion = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: true),
                    OrdenPago = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    AnioMesAfectacion = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Documento = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Secuencia = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Funcion = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    CodigoLiquidacion = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Importe = table.Column<decimal>(type: "decimal", fixedLength: true, nullable: false),
                    Signo = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    MarcaTransferido = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Moneda = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    RegimenEstatutario = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    CaracterRevista = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Dependencia = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Distrito = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    TipoOrganizacion = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    NroEstab = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    Categoria = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    TipoCargo = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    HorasDesignadas = table.Column<decimal>(type: "decimal", fixedLength: true, nullable: false),
                    Subvencion = table.Column<string>(type: "varchar(20)", fixedLength: true, nullable: false),
                    RegistroValido = table.Column<string>(type: "char(1)", fixedLength: true, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MEC_TMPMecanizadas", x => x.idTMPMecanizada);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MEC_CabeceraLiquidacion_MEC_TMPMecanizadas_IdCabecera",
                        column: x => x.IdCabecera,
                        principalTable: "MEC_TMPMecanizadas",
                        principalColumn: "idTMPMecanizada",
                        onDelete: ReferentialAction.Cascade);
                });
