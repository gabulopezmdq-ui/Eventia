...
function Retenciones() {
  ...
  const handleNuevoTipo = () => {
    navigate("/RetencionesFE/Nuevo");
  };

  const handleEditarTiposFunciones = (idRetencion) => {
    const url = `/RetencionesFE/Edit/${idRetencion}`;
    navigate(url);
  };
                  ...
                  },
                  {
                    ...
                    Cell: ({ row }) => (
                      <MDButton
                        ...
                        color="info"
                        size="small"
                        onClick={() => handleEditarTiposFunciones(row.original.idRetencion)}
                      >
                        Editar
                      </MDButton>
                    ),
